...
function PopularGames() {
 ...
 onMount(async () => {
  try {
   ...
   let display_settings = await invoke<any>("get_gamehub_settings");
 ...
 async function fetchDominantColors() {
  try {
   ...
   const colorStrings = await invoke("check_dominant_color_vec", {
 ...
 async function lightenRgbColor(rgbString, percentage, borderColor) {
  ...
  let lightenedRgb = [
   blendWithWhite(r, percentage),
   blendWithWhite(g, percentage),
   blendWithWhite(b, percentage),
  ];
  let currentContrast = contrastRatio(lightenedRgb, [
   borderR,
   borderG,
   borderB,
  ]);
 ...
 return (
  <>
   <div class="popular-games-grid">
    ...
    >
     {isLoading() ? (
      <div class="loading-icon-pop-games">
       <svg
      ...
      <div class="main-game-container">
       <div class="main-game-image-zoomed-in">
        <img
       ...
       <div
        class="main-game-info-container"
        style={{
       ...
       >
        ...
        <div id="game-details">
         ...
         <p>
          <strong>Original Size:</strong> {gameDetails().OriginalSize}
         </p>
         <p>
        ...
        >
         ...
         >
          ...
          <g class="frame-children">
           <path d="m903 450.75-6 6 6 6" style="fill:none" class="fills" />
           ...
           <path d="M897 456.75h14" style="fill:none" class="fills" />
           <g stroke-linecap="round" stroke-linejoin="round" class="strokes">
            <path
             d="M897 456.75h14"
             style={`fill:none;fill-opacity:none;stroke-width:2;stroke:${borderColor()};stroke-opacity:1`}
           ...
           <path d="M915 463.75v-14" style="fill:none" class="fills" />
           <g stroke-linecap="round" stroke-linejoin="round" class="strokes">
            <path
             d="M915 463.75v-14"
             style={`fill:none;fill-opacity:none;stroke-width:2;stroke:${borderColor()};stroke-opacity:1`}
    ...
    <div class="item-skipper-container">
     <div
      class="item-skipper"
     ...
     >
      {Array.from({ length: numberOfGames() }, (_, index) => (
       <div
        class={`item-elipse ${selectedGame() === index ? "active" : "inactive"}`}
        style={{
       ...
       >
        <svg
         ...
         version="1.1"
        >
         <g id="shape-fab4a6ec-74ec-8017-8005-2a1923de04fc">
          <defs></defs>
