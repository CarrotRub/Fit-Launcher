import PathText from "../../../../../../components/UI/PathText/PathText";
import { SettingsDropdownLabelProps, SettingsPathTextLabelProps } from "../../../../../../types/settings/ui";
import TitleLabel from "../TitleLabel/TitleLabel";

export default function LabelPathTextSettings(props: SettingsPathTextLabelProps) {
    return (
