        ...
        <div className="settings-sidebar">
            <div className="settings-sidebar-group">
                ...
                <ul className="settings-sidebar-group-list-category">
                    ...
                    <a id="settings-transferopts" onClick={() => handleActivateElem("settings-transferopts", "transferopts")}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--text-color)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-down-up"><path d="m3 16 4 4 4-4m-4 4V4m14 4-4-4-4 4m4-4v16"/></svg>
