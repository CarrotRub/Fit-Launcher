...
export function Modal<T extends unknown[]>(props: ModalPopupProps<T>) {
    ...
    return (
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div class={`relative bg-popup-background rounded-xl shadow-2xl border border-secondary-20 max-h-[96vh] no-scrollbar overflow-y-auto max-w-${props.maxWidth ? props.maxWidth : "md"} w-fit mx-4 transition-all duration-300 transform`}>
                {/* Close Button */}
                ...
                <div class="flex justify-end gap-3 px-6 py-4 bg-popup">
                    ...
                    <Button
                        ...
                        disabled={props.disabledConfirm ? props.disabledConfirm() : false}
                    />
                </div>
            </div>
        </div>
