...
export const commands = {
  ...
  async removeDownloadedGame(gameTitle: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("remove_downloaded_game", { gameTitle }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async decryptTorrentFromPaste(
    pasteLink: string
  ): Promise<Result<number[], Error>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("decrypt_torrent_from_paste", { pasteLink }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_download_settings"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async aria2StartTorrent(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("aria2_start_torrent", {
          torrent,
          dir,
          selectedFiles,
        }),
  ...
  async dmAddDdlJob(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("dm_add_ddl_job", { files, target, game }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getSingularGameLocal(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_singular_game_local", { url }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async removeGameToDownload(gameTitle: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("remove_game_to_download", { gameTitle }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async updateDownloadedGameExecutableInfo(
    gameTitle: string,
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("update_downloaded_game_executable_info", {
          gameTitle,
          executableInfo,
        }),
      };
  ...
  async resetGamehubSettings(): Promise<
    Result<null, SettingsConfigurationError>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("reset_gamehub_settings"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteGameFolderRecursively(
    folderPath: string
  ): Promise<Result<null, TorrentApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("delete_game_folder_recursively", {
          folderPath,
        }),
      };
    } catch (e) {
  ...
  async checkDominantColorVec(
    listImages: string[]
  ): Promise<Result<string[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("check_dominant_color_vec", { listImages }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async executableInfoDiscovery(
    pathToExe: string,
    pathToFolder: string
  ): Promise<ExecutableInfo | null> {
    return await TAURI_INVOKE("executable_info_discovery", {
      pathToExe,
      pathToFolder,
    });
  },
  ...
  async aria2GetListStopped(): Promise<Result<Status[], Aria2Error>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("aria2_get_list_stopped"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async transformLegacyDownload(
    legacyItems: LegacyDownloadedGame[]
  ): Promise<DownloadedGame[]> {
  ...
  async addGameToCollection(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("add_game_to_collection", {
          collectionName,
          game,
        }),
      };
  ...
  async getGamesImages(
    gameLink: string
  ): Promise<Result<string[], CustomError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_games_images", { gameLink }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async aria2TaskProgress(
    tasks: AriaTask[]
  ): Promise<Result<AriaTaskProgress, Aria2Error>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("aria2_task_progress", { tasks }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getSingularGameInfo(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_singular_game_info", { gameLink }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listTorrentFiles(
    magnet: string
  ): Promise<Result<FileInfo[], TorrentApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("list_torrent_files", { magnet }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async aria2Resume(gid: string): Promise<Result<null, Aria2Error>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("aria2_resume", { gid }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async aria2StartDownload(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("aria2_start_download", {
          url,
          dir,
          filename,
        }),
  ...
  async changeGamehubSettings(
    settings: GamehubSettings
  ): Promise<Result<null, SettingsConfigurationError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_gamehub_settings", { settings }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async extractFuckingfastDdl(
    fuckingfastLinks: string[]
  ): Promise<DirectLink[]> {
   ...
   */
  async aria2TaskSpawn(
    directLinks: DirectLink[],
    dir: string | null
  ): Promise<Result<AriaTaskResult[], Aria2Error>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("aria2_task_spawn", { directLinks, dir }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async aria2GetListActive(): Promise<Result<Status[], Aria2Error>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("aria2_get_list_active"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async aria2GetListWaiting(): Promise<Result<Status[], Aria2Error>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("aria2_get_list_waiting"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getDatahosterLinks(
    ...
    return await TAURI_INVOKE("get_datahoster_links", {
      gameLink,
      datahosterName,
    });
  },
  ...
  async magnetToFile(
    magnet: string
  ): Promise<Result<number[], TorrentApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("magnet_to_file", { magnet }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async runAutomateSetupInstall(
    path: string
  ): Promise<Result<null, TorrentApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("run_automate_setup_install", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeInstallationSettings(
    settings: InstallationSettings
  ): Promise<Result<null, SettingsConfigurationError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_installation_settings", { settings }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async addDownloadedGame(game: DownloadedGame): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("add_downloaded_game", { game }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async removeCollection(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("remove_collection", { collectionName }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async aria2GetStatus(gid: string): Promise<Result<Status, Aria2Error>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("aria2_get_status", { gid }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeDnsSettings(
    settings: FitLauncherDnsConfig
  ): Promise<Result<null, SettingsConfigurationError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_dns_settings", { settings }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async resetInstallationSettings(): Promise<
    Result<null, SettingsConfigurationError>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("reset_installation_settings"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async importCookiesFile(jsonPath: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("import_cookies_file", { jsonPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async removeGameFromCollection(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("remove_game_from_collection", {
          gameTitle,
          collectionName,
        }),
      };
  ...
  async getNewlyAddedGames(): Promise<Result<Game[], ScrapingError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_newly_added_games"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async dmAddTorrentJob(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("dm_add_torrent_job", {
          magnet,
          filesList,
          target,
          game,
  ...
  async aria2Remove(gid: string): Promise<Result<null, Aria2Error>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("aria2_remove", { gid }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async importCookies(cookies: Cookies): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("import_cookies", { cookies }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async configChangeOnlyPath(
    downloadPath: string
  ): Promise<Result<null, TorrentApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("config_change_only_path", { downloadPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async extractGame(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("extract_game", { jobPath, autoClean }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getTorrentHash(torrent: number[]): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_torrent_hash", { torrent }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getRecentlyUpdatedGames(): Promise<Result<Game[], ScrapingError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_recently_updated_games"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeDownloadSettings(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_download_settings", { config }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async querySearchIndex(
    query: string
  ): Promise<Result<SearchIndexEntry[], ScrapingError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("query_search_index", { query }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
...
export type AggregatedStatus = {
  ...
  upload_speed: number;
  per_file: Partial<{ [key in string]: FileStatus }>;
  state: DownloadState;
  progress_percentage: number;
};
export type Aria2Error = "NotConfigured" | { RPCError: string };
export type AriaTask = { gid: string; filename: string };
export type AriaTaskProgress = {
  completed: number;
  download_speed: number;
  total_length: number;
  completed_length: number;
};
export type AriaTaskResult = {
  task: AriaTask | null;
  error: Aria2Error | null;
};
...
export type BittorrentStatus = {
  announceList: string[][];
  comment: string | null;
  creationDate?: string | null;
  mode: BitTorrentFileMode | null;
};
...
export type DiscoveryGame = {
  ...
  game_torrent_paste_link: string;
  game_secondary_images: string[];
  game_tags: string;
  game_href: string;
};
...
export type ExecutableInfo = {
  ...
  executable_last_opened_date: string | null;
  executable_play_time: number;
  executable_installed_date: string | null;
  executable_disk_size: number;
};
 ...
 *
 */
export type FitLauncherConfigAria2 = {
  port: number;
  token: string | null;
  start_daemon: boolean;
  file_allocation: FileAllocation;
};
export type FitLauncherConfigV2 = {
  general: General;
...
export type FitLauncherDnsConfig = {
  system_conf: boolean;
  protocol: string;
  primary: string | null;
...
export type GamehubSettings = {
  nsfw_censorship: boolean;
  auto_get_colors_popular_games: boolean;
};
...
export type LegacyDownloadedGame = {
...
export type ScrapingError =
  | { type: "articleNotFound"; data: string }
  | { type: "reqwestError"; data: string }
  | { type: "selectorError"; data: string }
  | { type: "fileJSONError"; data: string }
  | { type: "creatingFileError"; data: CreatingFileErrorStruct }
  | { type: "globalError"; data: string }
  | { type: "httpStatusCodeError"; data: string }
...
export type Status = {
  ...
  dir: string;
  files: File[];
  bittorrent: BittorrentStatus | null;
  /**
