    ...
    <div className="sidebar-container">
        ...
        <ul className="useful-links">
          <li id="link-gamehub" >
              ...
              <svg className="links-svgs" width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.5 7.615V13.5" stroke="#fff" stroke-width="1.308" stroke-linecap="round"/>
                <rect x="4.115" y="5.654" width="11.769" height="9.808" rx="1.962" stroke="#fff" stroke-width="1.308"/>
                <path d="M18.5 7.615V13.5" stroke="#fff" stroke-width="1.308" stroke-linecap="round"/>
              </svg>
              <p className="links-texts"> Game Hub </p>
            ...
            <nav>
                <li id="link-library">
                  <A href="/mylibrary">
                    <svg className="links-svgs" width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="3.58333" y="4.08333" width="4.66667" height="4.66667" rx="0.583333" stroke="white" stroke-width="1.16667"/>
                      <rect x="11.75" y="4.08333" width="4.66667" height="4.66667" rx="0.583333" stroke="white" stroke-width="1.16667"/>
                      <rect x="3.58333" y="12.25" width="4.66667" height="4.66667" rx="0.583333" stroke="white" stroke-width="1.16667"/>
                      <rect x="11.75" y="12.25" width="4.66667" height="4.66667" rx="0.583333" stroke="white" stroke-width="1.16667"/>
                    </svg>
                    <p className="links-texts">{translate('my_library_placeholder', {})}</p>
                  </A>
                </li>
            </nav>
          ...
          <li id="link-settings">
              ...
              <p className="links-texts" > {translate('settings_placeholder', {})}</p>
      ...
      <div className="sidebar-games">
        ...
        <span className="sidebar-heading-text">
          <br type="text" />{translate('recently_downloaded_games_placeholder', {})}<br/>
        </span>
      ...
      <div className="sidebar-downloading-game">
        <p className="sidebar-heading">
          <span className="sidebar-heading-text">
            <br/>{translate('downloading_games_placeholder', {})}<br/>
          </span>
        </p>
