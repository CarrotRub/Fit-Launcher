...
const [installationConfigurations, setInstallationConfigurations] =
 makePersisted(
  createStore({
   two_gb_limit: true,
...
const [globalTorrentsInfo, setGlobalTorrentsInfo] = makePersisted(
 createStore({
  torrents: [],
 }),
);

function addGlobalTorrentsInfo(
 torrentExternInfo,
 torrentIdx,
 torrentOutputFolder,
...
const [downloadGamePageInfo, setDownloadGamePageInfo] = makePersisted(
 createStore({
  gameTitle: "",
  gameHref: "",
  filePath: "",
