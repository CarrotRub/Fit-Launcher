...
fn main() {
    ...
    // NOTE: The main GUI app now runs WITHOUT elevation (asInvoker).
    // The elevated installer-controller binary handles privileged operations.
    // We still include Common-Controls for modern UI rendering.
